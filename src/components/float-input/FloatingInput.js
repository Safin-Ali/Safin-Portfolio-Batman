...
const FloatingInput = ({children,type='text',name='',className=''}) => {
    return (
        <div className={`relative ${className} z-0 mb-6 w-full group`}>
            <input type={type} name={name} id="floating_email" className="block py-2.5 px-0 w-full text-sweetWhite bg-transparent border-0 border-b border-blackBlueLow  appearance-none focus:outline-none focus:ring-0 focus:border-bootstrap peer" placeholder=" " required />
